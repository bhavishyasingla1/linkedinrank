        ...
        <main className="min-h-screen bg-white">
            ...
            <article className="max-w-xl mx-auto px-6 py-16 sm:py-20">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-8 sm:p-10 text-center shadow-[0_4px_16px_rgba(0,0,0,0.06)] mb-10">
                    ...
                    <p className="text-xs text-[#6B7280] mt-5">We aim to respond within 48 hours</p>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-8 sm:p-10 text-center shadow-[0_4px_16px_rgba(0,0,0,0.06)] mb-10">
                    ...
                    <p className="text-xs text-[#6B7280] mt-5">We typically reply within 24 hours</p>
                </div>

                {/* Helpful links */}
                <div className="bg-[#F8FAFC] border border-gray-100 rounded-xl p-6">
                    <p className="text-xs font-bold text-[#6B7280] uppercase tracking-wider mb-4">Before reaching out</p>
