                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <aside className="lg:w-72 shrink-0 space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-[#0A66C2] to-[#004182] rounded-xl p-5 text-center">
                                <h3 className="text-white font-semibold text-sm mb-2">Want a full profile analysis?</h3>
                                <p className="text-blue-100 text-xs mb-3">Upload your PDF and get your LinkedIn score with personalized tips</p>
                                <Link
                                    href="/"
                            ...
                            {/* SEO: Secondary keywords linking to blogs */}
                            <div className="bg-white border border-gray-200 rounded-xl p-4">
                                <h3 className="text-xs font-bold text-[#9CA3AF] uppercase tracking-wider mb-3">Popular Searches</h3>
                                <div className="flex flex-wrap gap-1.5">
                                    {tool.secondaryKeywords.map(kw => (
                                        <Link
                                            key={kw}
                                            href={`/blogs`}
                                            className="text-[10px] bg-gray-100 text-[#6B7280] hover:bg-blue-50 hover:text-[#0A66C2] px-2 py-1 rounded-full transition-colors"
                                        >
                                            {kw}
                                        </Link>
                                    ))}
