        ...
        (
            ...
            >
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                    <span style={{ fontSize: 48, fontWeight: 800, color: '#FFFFFF', letterSpacing: -1 }}>
                        LinkedIn
                    </span>
                    <span style={{ fontSize: 48, fontWeight: 800, color: '#0A66C2', letterSpacing: -1 }}>
                        Rank
                    </span>
                </div>
                ...
                {/* URL */}
                <p style={{ position: 'absolute', bottom: 24, fontSize: 16, color: 'rgba(255,255,255,0.35)', fontWeight: 500 }}>
                    linkedinrank.com
                </p>
            </div>
        ),
