                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-2 sm:col-span-1">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href="https://www.instagram.com/linkedinrank/" target="_blank" rel="noopener noreferrer" aria-label="LinkedInRank on Instagram" className="text-[#6B7280] hover:text-[#E4405F] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center">
                            ...
                            <a href="mailto:hello@linkedinrank.com" aria-label="Email LinkedInRank" className="text-[#6B7280] hover:text-[#0A0F1C] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center">
